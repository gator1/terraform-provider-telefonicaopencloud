...
Using this TelefonicaOpenCloud provider with Rackspace is not supported and not
...
```
resource "telefonicaopencloud_compute_instance_v2" "my_instance" {
  name      = "my_instance"
  region    = "DFW"
...
Most of Terraform's TelefonicaOpenCloud support is done in a standardized Packstack
...
up-to-date TelefonicaOpenCloud environment with the latest TelefonicaOpenCloud services.
