...
* `remote_group_id` - (Optional) The remote group id, the value needs to be an
    TelefonicaOpenCloud ID of a security group in the same tenant. Changing this creates
    a new security group rule.

* `security_group_id` - (Required) The security group id the rule should belong
    to, the value needs to be an TelefonicaOpenCloud ID of a security group in the same
