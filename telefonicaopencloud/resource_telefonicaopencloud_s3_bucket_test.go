		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.test"),
					resource.TestMatchResourceAttr(
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "acceleration_status", "Enabled"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "acceleration_status", "Suspended"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWSS3BucketPolicy(
						"telefonicaopencloud_s3_bucket.bucket", testAccAWSS3BucketPolicy(rInt)),
				),
			},
			{
				Config: testAccAWSS3BucketConfig(rInt),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWSS3BucketWebsite(
						"telefonicaopencloud_s3_bucket.bucket", "", "", "", ""),
					testAccCheckAWSS3BucketWebsiteRoutingRules("telefonicaopencloud_s3_bucket.bucket", nil),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "website_endpoint", ""),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckAWSS3DestroyBucket("telefonicaopencloud_s3_bucket.bucket"),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					/*resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.transition.2000431762.date", ""),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.transition.2000431762.days", "30"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.transition.2000431762.storage_class", "STANDARD_IA"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.transition.6450812.date", ""),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.transition.6450812.days", "60"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.transition.6450812.storage_class", "GLACIER"), */
					resource.TestCheckResourceAttr(
					...
					/*resource.TestCheckResourceAttr(
					"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.transition.460947558.days", "0"), */
					resource.TestCheckResourceAttr(
					...
					/*resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.3.tags.tagKey", "tagValue"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.3.tags.terraform", "hashicorp"), */
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					/*resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.1377917700.days", "30"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.1377917700.storage_class", "STANDARD_IA"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.2528035817.days", "60"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.0.noncurrent_version_transition.2528035817.storage_class", "GLACIER"), */
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.id", "id2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.1.prefix", "path2/"),
					...
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.prefix", "path3/"),
					/*resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.noncurrent_version_transition.3732708140.days", "0"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_s3_bucket.bucket", "lifecycle_rule.2.noncurrent_version_transition.3732708140.storage_class", "GLACIER"), */
				),
			},
			{
				Config: testAccAWSS3BucketConfig(rInt),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExistsWithProviders("telefonicaopencloud_s3_bucket.bucket", &providers),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExistsWithProviders("telefonicaopencloud_s3_bucket.bucket", &providers),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket.bucket", "replication_configuration.#", "1"),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket.bucket", "replication_configuration.0.rules.#", "1"),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket.bucket", "replication_configuration.0.rules.2229345141.id", "foobar"),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket.bucket", "replication_configuration.0.rules.2229345141.prefix", "foo"),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket.bucket", "replication_configuration.0.rules.2229345141.status", s3.ReplicationRuleStatusEnabled),
				),
			},
		},
	})
...
// FAIL provider "telefonicaopencloud" is not available
...
resource "telefonicaopencloud_iam_role" "role" {
...
resource "telefonicaopencloud_s3_bucket" "destination" {
    provider = "telefonicaopencloud.reg2"
...
resource "telefonicaopencloud_s3_bucket" "bucket" {
    ...
    replication_configuration {
        role = "${telefonicaopencloud_iam_role.role.arn}"
        rules {
            id     = "foobar"
            prefix = "foo"
            status = "Enabled"
            ...
            destination {
                bucket        = "${telefonicaopencloud_s3_bucket.destination.arn}"
