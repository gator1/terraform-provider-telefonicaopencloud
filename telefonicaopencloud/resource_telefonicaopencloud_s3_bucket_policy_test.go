		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckAWSS3BucketHasPolicy("telefonicaopencloud_s3_bucket.bucket", expectedPolicyText),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckAWSS3BucketHasPolicy("telefonicaopencloud_s3_bucket.bucket", expectedPolicyText1),
				),
			},

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketExists("telefonicaopencloud_s3_bucket.bucket"),
					testAccCheckAWSS3BucketHasPolicy("telefonicaopencloud_s3_bucket.bucket", expectedPolicyText2),
				),
			},
		},
	})
