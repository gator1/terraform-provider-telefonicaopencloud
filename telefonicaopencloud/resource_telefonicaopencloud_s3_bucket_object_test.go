	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check:  testAccCheckAWSS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
			},
		},
	})
}
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &originalObj),
			...
			resource.TestStep{
				...
				Config: testAccAWSS3BucketObjectConfig_updatesWithVersioning(rInt, tmpFile.Name()),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &modifiedObj),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSS3BucketObjectExists("telefonicaopencloud_s3_bucket_object.object", &obj),
					resource.TestCheckResourceAttr("telefonicaopencloud_s3_bucket_object.object", "tags.%", "2"),
				),
			},
		},
	})
...
func testAccAWSS3BucketObjectConfig_withKMSId(randInt int) string {
	return fmt.Sprintf(`
resource "telefonicaopencloud_kms_key" "kms_key_1" {
}
...
resource "telefonicaopencloud_s3_bucket_object" "object" {
	...
	key = "test-key"
	content = "stuff"
	kms_key_id = "${telefonicaopencloud_kms_key.kms_key_1.arn}"
}
`, randInt)
}
*/
