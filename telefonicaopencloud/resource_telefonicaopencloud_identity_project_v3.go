...
func resourceIdentityProjectV3Create(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return fmt.Errorf("Error creating TelefonicaOpenCloud identity client: %s", err)
	}
	...
	if err != nil {
		return fmt.Errorf("Error creating TelefonicaOpenCloud project: %s", err)
	}
...
func resourceIdentityProjectV3Read(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] Retrieved TelefonicaOpenCloud project: %#v", project)
...
func resourceIdentityProjectV3Update(d *schema.ResourceData, meta interface{}) error {
	...
	if hasChange {
		...
		if err != nil {
			return fmt.Errorf("Error updating TelefonicaOpenCloud project: %s", err)
		}
	}
...
func resourceIdentityProjectV3Delete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return fmt.Errorf("Error deleting TelefonicaOpenCloud project: %s", err)
	}
