...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"telefonicaopencloud_s3_bucket_object":       dataSourceAwsS3BucketObject(),
		},
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"telefonicaopencloud_s3_bucket":                       resourceAwsS3Bucket(),
			"telefonicaopencloud_s3_bucket_policy":                resourceAwsS3BucketPolicy(),
			"telefonicaopencloud_s3_bucket_object":                resourceAwsS3BucketObject(),
		},
