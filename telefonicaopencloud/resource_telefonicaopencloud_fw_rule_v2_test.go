		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("telefonicaopencloud_fw_rule_v2.rule_1", rule1),
				),
			},
			resource.TestStep{
				Config: testAccFWRuleV2_basic_2,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("telefonicaopencloud_fw_rule_v2.rule_1", rule2),
				),
			},
			resource.TestStep{
				Config: testAccFWRuleV2_basic_3,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("telefonicaopencloud_fw_rule_v2.rule_1", rule3),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFWRuleV2Exists("telefonicaopencloud_fw_rule_v2.rule_1", rule),
				),
			},
		},
	})
