...
func (lrt *LogRoundTripper) RoundTrip(request *http.Request) (*http.Response, error) {
	...
	if lrt.OsDebug {
		...
		log.Printf("[DEBUG] TelefonicaOpenCloud Request Headers:\n%s", FormatHeaders(request.Header, "\n"))
	...
	if lrt.OsDebug {
		log.Printf("[DEBUG] TelefonicaOpenCloud Response Code: %d", response.StatusCode)
		log.Printf("[DEBUG] TelefonicaOpenCloud Response Headers:\n%s", FormatHeaders(response.Header, "\n"))
...
// FirewallGroup is an TelefonicaOpenCloud firewall group.
